...
namespace TemplateSistema.Persistence.Migrations
{
    ...
    [Migration("20260721222628_AddNucleoAndEvolveSetor")]
    partial class AddNucleoAndEvolveSetor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TemplateSistema.Domain.Entities.Setor", b =>
                {
                    ...
                    b.Property<Guid?>("ChefeSubstitutoServidorId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ChefeSubstitutoServidorId");
            ...
            modelBuilder.Entity("TemplateSistema.Domain.Entities.Setor", b =>
                {
                    ...
                    b.HasOne("TemplateSistema.Domain.Entities.Servidor", "ChefeSubstitutoServidor")
                        .WithMany()
                        .HasForeignKey("ChefeSubstitutoServidorId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("ChefeSubstitutoServidor");
