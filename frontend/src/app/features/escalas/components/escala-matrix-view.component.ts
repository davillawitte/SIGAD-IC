...
@Component({
  selector: 'app-escala-matrix-view',
  imports: [CommonModule],
  templateUrl: './escala-matrix-view.component.html',
  styleUrl: './escala-matrix-view.component.scss',
})
export class EscalaMatrixViewComponent {
