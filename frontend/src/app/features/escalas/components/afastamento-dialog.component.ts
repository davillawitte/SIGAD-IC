...
@Component({
  ...
  templateUrl: './afastamento-dialog.component.html',
})
export class AfastamentoDialogComponent implements OnInit {
  private readonly api = inject(AfastamentosApiService);
  private readonly fb = inject(FormBuilder);
  private readonly dialogRef = inject(MatDialogRef<AfastamentoDialogComponent, AfastamentoItem | false>);
