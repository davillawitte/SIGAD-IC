...
@Component({
  selector: 'app-escala-calendario-page',
  imports: [
    CommonModule,
    MatDialogModule,
    PciAlertComponent,
  ...
  templateUrl: './escala-calendario-page.component.html',
  styleUrl: './escala-calendario-page.component.scss',
})
export class EscalaCalendarioPageComponent implements OnInit {
