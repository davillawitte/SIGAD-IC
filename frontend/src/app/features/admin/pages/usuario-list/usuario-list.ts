...
export class UsuarioList implements OnInit {
  ...
  readonly canCreate = this.auth.hasPermission('usuarios.criar');
  readonly canEdit = this.auth.hasPermission('usuarios.editar');
  ...
  readonly rowActions = computed<PciRowAction<UsuarioRow>[]>(() => {
    const actions: PciRowAction<UsuarioRow>[] = [];
    if (this.canEdit) {
