...
@Component({
  ...
  templateUrl: './estrutura-list.html',
  styleUrl: './estrutura-list.scss',
})
export class EstruturaList implements OnInit, OnDestroy {
  ...
  readonly canCreateNucleo = this.auth.hasPermission('nucleos.criar');
  readonly canCreateSetor = this.auth.hasPermission('setores.criar');
  readonly canEditNucleo = this.auth.hasPermission('nucleos.editar');
  readonly canEditSetor = this.auth.hasPermission('setores.editar');
  ...
  readonly canCreateAny = this.canCreateNucleo || this.canCreateSetor;
